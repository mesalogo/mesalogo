...
| **Domain entity apps** | RPG game world, RPA (regulatory scenario), GIS map MCP tools (`add_map_layer`, `set_map_view`, `draw_map_geometry`, …). ([RPA plan](./docs/feature-nextrpa/PLAN.md)) | 📋 Planned |
