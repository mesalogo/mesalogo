...
制造业智能专家协作平台是一个基于多智能体技术的企业级决策支持系统，旨在连接某大型制造企业内外部专家资源，通过多种协作模式实现跨领域、跨部门的高效协同。平台集成企业知识库、行业专家经验和大模型能力，为产品创新、供应链优化、市场决策等方面提供智能化支持。
