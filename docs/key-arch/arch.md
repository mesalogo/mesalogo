...
graph TD
    ...
    class Enterprise,Medical,Education,Legal,Military,RD,Government applicationLayer
...
- **政务业务场景**：通关审核、风险评估、政策解读、跨境贸易合规分析
