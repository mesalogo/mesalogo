...
export default {
  ...
  'assistantSettings.generalTitle': 'General Assistant Generation',
  'assistantSettings.generalDescription': 'Controls general AI-assisted generation for role prompts, action spaces, and task content.',
  'assistantSettings.experimentProtocolTitle': 'Experiment Protocol Generation',
  'assistantSettings.experimentProtocolDescription': 'Generates reviewable behavior protocols and experiment rules for Parallel Lab, including a base protocol before scan variables are configured.',
  'assistantSettings.enableExperimentProtocol': 'Enable Experiment Protocol Generation',
  'assistantSettings.enableExperimentProtocol.tooltip': 'Allows AI generation and regeneration of behavior protocols while designing a Parallel Lab experiment.',
  'assistantSettings.experimentProtocolModel': 'Experiment Protocol Model',
  'assistantSettings.experimentProtocolModel.tooltip': 'Used only for experiment behavior protocols and rules; other assistant-generation scenarios are unaffected.',
  'assistantSettings.selectExperimentProtocolModel': 'Select an experiment protocol model',
  'assistantSettings.manageExperimentProtocolTemplate': 'Edit Experiment Protocol Template',
