...
export default {
  ...
  // ----- RoleCardView -----
  'roleCard.source.systemTooltip': '系统资源，所有用户可见可用',
  'roleCard.source.system': '系统',
  'roleCard.source.sharedTooltip': '用户共享资源，所有用户可见可用',
  'roleCard.source.shared': '共享',
  'roleCard.source.privateTooltip': '私有资源，仅创建者可见',
  'roleCard.source.private': '私有',
  'roleCard.platform.custom': '自定义',
  'roleCard.defaultTextModel': '默认文本生成{{modelName}}',
  'roleCard.defaultModelSuffix': ' ({{name}})',
  'roleCard.defaultModel': '默认',
  'roleCard.empty': '暂无角色数据',
  'roleCard.action.edit': '编辑',
  'roleCard.action.delete': '删除',
  'roleCard.type.external': '外部',
  'roleCard.type.internal': '内部',
  'roleCard.capabilities': '能力',
  'roleCard.knowledgeBases': '知识库',
  'roleCard.skills': '技能',

  // ----- useRoleManagement -----
  'roleManagement.fetchRolesFailed': '获取角色列表失败: {{reason}}',
  'roleManagement.fetchModelsFailed': '获取模型列表失败: {{reason}}',
  'roleManagement.fetchCapabilitiesFailed': '获取能力列表失败: {{reason}}',
  'roleManagement.internalKnowledgeBaseName': '内部知识库',
  'roleManagement.fetchKnowledgesFailed': '获取知识库列表失败: {{reason}}',
  'roleManagement.fetchActionSpacesFailed': '获取行动空间列表失败',
  'roleManagement.createSuccess': '角色创建成功',
  'roleManagement.quotaExceeded': '配额超限：{{message}}',
  'roleManagement.quotaDefault': '您的计划已达到智能体数量上限',
  'roleManagement.createFailed': '创建角色失败',
  'roleManagement.updateSuccess': '角色更新成功',
  'roleManagement.updateFailed': '更新角色失败',
  'roleManagement.deleteSuccess': '角色删除成功',
  'roleManagement.deleteFailed': '删除角色失败',
  'roleManagement.unknownError': '未知错误',
  'roleManagement.partialKnowledgeOpFailed': '部分知识库操作失败: {{reason}}',
  'roleManagement.knowledgeBindingSuccess': '知识库绑定更新成功',
  'roleManagement.partialCapabilityBindFailed': '角色创建成功，但部分能力绑定失败',
  'roleManagement.saveFailedCheckForm': '保存角色失败，请检查表单内容',
  'roleManagement.externalUpdateSuccess': '外部智能体更新成功',
  'roleManagement.externalImportSuccess': '外部智能体导入成功',
};
