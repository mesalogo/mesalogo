...
# The default is intentionally empty; pass --secret for reproducible licenses.
# Use a unique secret supplied through a secure channel in production.
DEFAULT_SECRET_KEY = ''
...
def main():
    ...
    parser.add_argument('--secret', help='用于签名的密钥；不提供则生成临时随机密钥')

    args = parser.parse_args()

    # Use the CLI secret; an empty value generates a temporary random secret.
